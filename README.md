...
```shell
# 使用你的编号和姓名拼音代替双引号中内容
git config --global user.name "2022040010-Feifan Lu"
# 使用你的邮箱代替双引号中内容
git config --global user.email "a1198079847@163.com"
```
...
`/home/lff/code/phase-3/projects/cpu/build_test/emu-compile/main.d`需要修改此文件内的绝对路径为自己文件的绝对路径  

`/home/lff/code/phase-3/projects/counter/build_test/emu-compile/main.d`这个里面的绝对路径同样需要修改，不然后面会提示:  
`make: *** No rule to make target '/home/zpn/Code/oscpu-framework/projects/cpu/csrc/main.cpp', needed by 'main.o'.  Stop.`  
